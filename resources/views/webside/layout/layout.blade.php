...
<head>
    ...
    <meta content="@yield('meta_keyword',$setting->title)" name="keywords">
            ...
            <div class="col-12 col-md-8">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="owl-carousel owl-carousel-1 tranding-carousel position-relative d-inline-flex align-items-center ml-3" style="width: calc(100% - 100px); padding-left: 90px;">
                            @foreach ($last_with_post as $item)
                        <div class="text-truncate"><a class="text-secondary" href="{{route('post',$item->id)}}">{{$item->title}}</a></div>
                        @endforeach
                    </div>
                </div>
            </div>
        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    <a href="{{route('index')}}" class="nav-item nav-link active">{{'words.home'}}</a>
                  @foreach ($categories as $category)
                    <div class="nav-item dropdown">
                        <a class="nav-link @if(count($category->childern) > 0) dropdown-toggle @endif "  @if (count($category->childern) == 0) href="{{route('categories',$category->id)}}" @else  href="#" @endif @if(count($category->childern) > 0) data-toggle="dropdown" @endif>{{$category->title}}</a>
                        @if(count($category->childern) > 0)
                            <div class="dropdown-menu rounded-0 m-0">
                                @foreach ($category->childern as $child)
                                <a href="{{route('categories',$child->id)}}" class="dropdown-item">{{$child->title}}</a>
                                @endforeach
                            </div>
                        @endif
                    </div>
                ...
                <ul class="nav navbar-nav pull-left hidden-md-down" style="margin-left: 150px">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                            <span class="hidden-md-down">{{__('words.Lang')}}</span>
                        </a>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 mb-5">
                ...
                <div class="d-flex flex-wrap m-n1">
                    ...
                    <a href="{{route('categories',$child->id)}}" class="btn btn-sm btn-outline-secondary m-1">{{$item->title}}</a>
                    @endforeach
                    {{-- <a href="" class="btn btn-sm btn-outline-secondary m-1">Politics</a>
                    <a href="" class="btn btn-sm btn-outline-secondary m-1">Business</a>
                    <a href="" class="btn btn-sm btn-outline-secondary m-1">Corporate</a>
