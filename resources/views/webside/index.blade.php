                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="owl-carousel owl-carousel-2 carousel-item-1 position-relative mb-3 mb-lg-0">
                            ...
                            <div class="position-relative overflow-hidden" style="height: 435px;">
                                ...
                                <div class="overlay">
                                    <div class="mb-1">
                                        <a class="text-white" href="">{{($item->category->title)}}</a>
                                        <span class="px-2 text-white">/</span>
                                        <a class="text-white" href="">{{($item->created_at->format(('Y-m-d')))}}</a>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="position-relative overflow-hidden mb-3" style="height: 80px;">
                            ...
                            <a href="{{route('categories',$item->id)}}" class="overlay align-items-center justify-content-center h4 m-0 text-white text-decoration-none">
                                {{($item->title)}}
                            </a>
                        </div>
                        ...
                        <div class="owl-carousel owl-carousel-3 carousel-item-2 position-relative">
                            ...
                            <div class="position-relative">
                                ...
                                <div class="overlay position-relative bg-light">
                                    ...
                                    <a class="h4 m-0" href="">{{$item->title}}</a>
                                </div>
                            </div>
                            @endforeach
