    ...
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            {{-- <li class="nav-title">
                ...
                <li class="nav-item">
                <a class="nav-link" href="{{ route('dashboard.categories.create') }}"><i class="icon-user-follow"></i>{{ __('words.add categories') }}</a>
                <a class="nav-link" href="{{ route('dashboard.categories.index') }}"><i class="icon-people"></i>{{ __('words.categories') }}</a>
                </li> --}}
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('dashboard.settings') }}"><i class="icon-people"></i> {{ __('words.setting') }}</a>
                </li>
            @endcan
            <!--<li class="nav-item nav-dropdown">
