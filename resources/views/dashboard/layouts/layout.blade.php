     ...
     <header class="navbar">
         <div class="container-fluid">
            ...
            <ul class="nav navbar-nav pull-left hidden-md-down">
                ...
                <li class="nav-item dropdown" style="margin-left:10px !important" >{{auth()->user()->name}} ({{auth()->user()->status}})</li>
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <div class="divider"></div>
                        <a class="dropdown-item" href="{{route('dashboard.users.edit',auth()->user()->id)}}">{{__('words.user setting')}}</a>
                        <a class="dropdown-item" href="{{ route('logout') }}"
                                    onclick="event.preventDefault();
                                    document.getElementById('logout-form').submit();"><i class="fa fa-lock"></i> {{ __('words.Logout') }}
                                    </a>
            ...
            {{-- <li class="nav-item">
              ...
              {{-- this code is set the language to project --}}
                <ul class="nav navbar-nav pull-left hidden-md-down">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
